SELECT add_check_if_not_exists('ratchat', 'chk_rat_tag_length', 'char_length(rat_tag) = 12'); --A call for to use the function add_check_if_not_exists. Args: Name of table, Name of constraint, check
